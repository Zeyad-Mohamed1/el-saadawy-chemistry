              ...
              <div className="w-full glassy smooth text-[#111827] shadow-large rounded-[.5rem] overflow-hidden">
                <div className="p-4 space-y-8">
                  ...
                  <button
                    ...
                    className="border-2 smooth false w-full text-center bg-green-600 border-secondary hover:bg-opacity-0 dark:hover:bg-opacity-0 bg-opacity-100 hover:text-white/80 text-white rounded-[.375rem] px-4 py-2 flex items-center justify-center gap-2"
                  >
                    {courseLoading ? (
                      <Loader2 className="w-10 h-10 animate-spin text-white" />
                    ) : (
